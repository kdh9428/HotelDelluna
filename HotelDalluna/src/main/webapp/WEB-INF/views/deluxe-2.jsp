							...
							<div class="clearfix">
										...
										<div class="fslider" data-arrows="false"
											...
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide">
														<a href="resources/images/logo/room-5.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-5.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-6.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-6.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-7.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-7.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-8.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-8.PNG" alt=""></a>
													</div>
												</div>
											</div>
										</div>
								...
								<div class="topmargin-sm">
									...
									<p>
										...
										체크인/체크아웃 : 14:00 / 11:00<br> 최대 수용인원 : 3명
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 전망 : 가든 뷰
									<hr style="border: solid 1px navy;">
									<h3>서비스</h3>
									<p>&middot; 제주도의 아름다운 자연 전망(가든 뷰)
									<p>
										&middot; Spa & Garden 해온: 사계절 야외수영장 및 자쿠지, 사우나<br>
										&middot; 해온(he:on) 베딩 시스템: 최상의 숙면을 위한 침대 및 침구류<br>
										&middot; 맞춤형 베개 제공<br> &middot; 요청 시 한실 베개, 젠 메밀 베개, 바이오
										베개, 메모리폼 베개, 양모 베개 제공<br> &middot; 전 객실 초고속 무료 인터넷 (유선,
										와이파이)
									<hr style="border: solid 1px navy;">
									<h3>어메니티</h3>
									<p>
										일반 : 55" LCD TV / 발코니 / 손전등 / 금고 / 사무용 데스크
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 욕실 : 욕실용품(몰튼브라운) / 비데 / 면도기 /
										목욕 가운 / 헤어드라이어<br> 기타 : 케이블,위성 TV채널 / 무료 생수 1일 3병 / 무료
										차(Tea) 서비스 제공
									<hr style="border: solid 1px navy;">
								</div>
							</div>
