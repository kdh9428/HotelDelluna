						...
						<div class="nobottommargin">
							...
							<div class="clearfix">
								...
								<p>
									...
									<a href="contact-1.jsp" class="btn btn-primary" role="button">문의하기</a>
								</p>
										...
										<div class="fslider" data-arrows="false"
											...
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide">
														<a href="resources/images/logo/room-13.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-13.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-14.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-14.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-15.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-15.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-16.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-16.PNG" alt=""></a>
													</div>
								...
								<div class="topmargin-sm">
									...
									<h3>객실개요</h3>
									<p>
										침대 타입 : 더블침대 2개 + 싱글침대 1개 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										체크인/체크아웃 : 14:00 / 11:00<br> 최대 수용인원 : 5명
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 전망 : 오션 뷰
									...
									<p>
										...
										&middot; 실내 자쿠지, 미팅/다이닝 공간<br> &middot; 전 객실 초고속 무료 인터넷
										(유선, 와이파이)
									<hr style="border: solid 1px navy;">
									<h3>어메니티</h3>
									<p>
										일반 : 75" LED TV / 발코니 / 손전등 / 금고 / 사무용 데스크
