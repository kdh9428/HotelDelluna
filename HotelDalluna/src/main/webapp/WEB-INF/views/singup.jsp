   	  ...
   	  <p></p>
   	  			...
   	  			<form name="form" id="form" class="form-signup" role="form" modelAttribute="userVO" method="post" action="${pageContext.request.contextPath}/user/insertUser">
   	  					...
   	  					<div class="form-group">
	   	  					...
	   	  					<div class="row">
		   	  					<div class="col-md-offset-1">
		   	  						<label for="password" class="col-md-2 col-md-offset-2 col-form-label text-md-right">비밀번호 </label>
		   	  					</div>
	   	  						<div class="col-md-5">
	   	  							<input type="password" path="password" id="password" class="form-control required sm-form-control " placeholder="비밀번호(8~32자리)" /> 
	   	  						</div>
	   	  					</div>
	   	  					</div>
	   	  					<div class="row">
		   	  					<div class="col-md-offset-1">
		   	  						<label for="password2" class="col-md-2 col-md-offset-2 col-form-label text-md-right">비밀번호 재입력 </label>
		   	  					</div>
	   	  						<div class="col-md-5">
