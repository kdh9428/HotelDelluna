...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="page-title-parallax"
			...
			<div class="container clearfix" style="border-width: 3px;">
				...
				<ol class="breadcrumb">
					...
					<li><a href="hotel-About-Us">회원 가입</a></li>
				</ol>
			</div>
		...
		<div class="container clearfix">
		<form:form id="memberDetails" class="form-signup" role="form" modelAttribute="memberDetails" method="post" action="singup" onsubmit="return validate()">
			<p></p>
