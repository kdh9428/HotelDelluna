...
<body class="stretched">
    ...
    <div id="wrapper" class="clearfix">
        ...
        <section id="page-title" class="page-title-parallax" style="background-image: url('resources/images/logo/room.PNG'); padding: 120px 0;" data-stellar-background-ratio="0.3">
            ...
            <div class="container clearfix">
                <FONT SIZE="6" COLOR="white">Hotel Delluna | Deluxe Room</FONT>
                <ol class="breadcrumb">
                </ol>
            </div>
					...
					<div class="nobottommargin clearfix">
						<div class="nobottommargin">
							<div class="clearfix">
								...
								<p>
									<a href="Reservation.do" class="btn btn-primary" role="button">예약하기</a>
										...
										<div class="fslider" data-arrows="false"
											...
											<div class="flexslider">
												<div class="slider-wrap">
													<div class="slide">
														<a href="resources/images/logo/room-1.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-1.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-2.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-2.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-3.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-3.PNG" alt=""></a>
													</div>
													<div class="slide">
														<a href="resources/images/logo/room-4.PNG"
															data-lightbox="gallery-item"><img class="image_fade"
															src="resources/images/logo/room-4.PNG" alt=""></a>
													</div>
								...
								<div class="topmargin-sm">
									...
									<h3>객실개요</h3>
									<p>
										침대 타입 : 더블침대 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 체크인/체크아웃 : 14:00 /
										11:00<br> 최대 수용인원 : 2명 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 전망
										: 마운틴 뷰
									<hr style="border: solid 1px navy;">
									<h3>서비스</h3>
									<p>&middot; 제주도의 아름다운 전망(마운틴 뷰)
									<p>
									...
									<h3>어메니티</h3>
									<p>
										일반 : 55" LCD TV / 발코니 / 손전등 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 욕실
										: 욕실용품(몰튼브라운) / 비데 / 면도기 / 목욕 가운 / 헤어드라이어<br> 기타 : 케이블,위성
										TV채널 / 무료 생수 1일 3병 / 무료 차(Tea) 서비스 제공
									<hr style="border: solid 1px navy;">
								</div>
							</div>
						</div>
                ...
                <div class="container clearfix">
                    ...
                    <div class="col_half col_last tright">
                        <div class="copyrights-menu copyright-links fright clearfix">
                            <a href="#">공지사항</a> <a href="hotel-About-Us.do">호텔소개</a> <a href="deluxe-double.do">객실</a> <a href="contact-2.jsp">예약조회 및 취소</a> <a href="contact.jsp">고객의 소리</a>
                        </div>
